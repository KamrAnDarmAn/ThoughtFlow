...
import { BlogModal } from "./pages/Profile";
...
export function Blogs() {
    ...
    const fetchBlogs = async () => {
        const blogs = await axios.get('http://localhost:5000/api/posts')
        setBlogs(blogs.data)
    }
    useEffect(() => {
        fetchBlogs()
            ...
            <AnimatePresence>
                {active && typeof active === "object" && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className=" inset-0 bg-black/20 h-full w-full z-10"
                    />
                )}
            </AnimatePresence>
            <AnimatePresence>
                {active && typeof active === "object" ? (
                    <AnimatePresence>
                        <BlogModal active={active} setActive={setActive} id={active.id} key={active.id} />
                    </AnimatePresence>
        ...
        content: () => {
            return (
                <p>
                    ...
                    her haunting voice and intintrospectiverospective lyrics. <br /> <br /> Her songs
